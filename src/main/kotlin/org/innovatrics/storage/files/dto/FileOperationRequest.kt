...
data class FileOperationRequest(
    ...
    @Schema(description = "Type of the file. Allowed values are 'attachments', 'faces', 'fingerprints', 'videos'",
        allowableValues = ["attachments", "faces", "fingerprints", "videos"], required = true)
